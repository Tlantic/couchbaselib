 ...
 *  @param {string} [ModelContext.fields.createdOn="_createdOn"] - Property name for createdOn timestamp
 *  @param {string} [ModelContext.fields.updateOn="_updatedOn"] - Property name for updatedOn timestamp
 *  @param {string} [ModelContext.fields.createdBy="_createdBy"] - Property name for createdBy reference
 *  @param {string} [ModelContext.fields.createdBy="_updatedBy"] - Property name for updatedBy reference
 * @since 2.0.0
 */
...
// ---------------------------------------------- BEGIN Class Methods ----------------------------------------------- //
	...
	static setContext( db, bucket, fields) {
		...
		if ( !fields ) {
			...
			fields.createdOn = fields.createdOn || '_createdOn';
			fields.updatedOn = fields.updatedOn || '_updatedOn';
			fields.createdBy = fields.createdBy || '_createdBy';
			fields.updatedBy = fields.updatedBy || '_updatedBy';
		}
