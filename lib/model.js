...
// --------------------------------------------- BEGIN Instance Methods --------------------------------------------- //
	...
	//noinspection JSUnusedGlobalSymbols
	/**
	 * Returns mapped uuid property
	 *
	 * @returns {DocumentUUID}
	 *
	 * @since 2.0.0
	 */
	getUUID() {
		return this[ this.constructor.getContext().fields.uuid ];
	}

	//noinspection JSUnusedGlobalSymbols
	/**
	 * Returns mapped createdOn property
	 *
	 * @returns {*}
	 *
	 * @since 2.0.0
	 */
	getCreatedOn() {
		return this[ this.constructor.getContext().fields.createdOn ];
	}

	//noinspection JSUnusedGlobalSymbols
	/**
	 * Returns mapped updatedOn property
	 *
	 * @returns {*}
	 *
	 * @since 2.0.0
	 */
	getUpdatedOn() {
		return this[ this.constructor.getContext().fields.updatedOn ];
	}

	//noinspection JSUnusedGlobalSymbols
	/**
	 * Returns mapped createdBy property
	 *
	 * @returns {*}
	 *
	 * @since 2.0.0
	 */
	getCreatedBy() {
		return this[ this.constructor.getContext().fields.createdBy ];
	}

	//noinspection JSUnusedGlobalSymbols
	/**
	 * Returns mapped updatedBy property
	 *
	 * @returns {*}
	 *
	 * @since 2.0.0
	 */
	getUpdatedBy() {
		return this[ this.constructor.getContext().fields.updatedBy ];
	}
	 ...
	 *  @param {Boolean} [options.returnOnlyValues=false]
	 *      Returns only value property of the result.
	 *  @param {Boolean} [options.views]
	 *      Views to index before returning the result.
	 *  @param {Bucket.CAS} [options.cas]
	 *      Unlocks the document if in a locked state.
	...
	/**
	 * Increments this instance counter value.
	 *
	...
	getCounter( options, callback ) {
		...
		context.db.get( context.bucket, `${this[ $KEY ]}::${options.key || 'counter'}`, _options, callback );
