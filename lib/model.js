...
// --------------------------------------------- BEGIN Instance Methods --------------------------------------------- //
	 ...
	 */
	getUUID() {
		return this[ TypeModel.getContext().fields.uuid ];
	}
	 ...
	 */
	getCreatedOn() {
		return this[ TypeModel.getContext().fields.createdOn ];
	}
	 ...
	 */
	getUpdatedOn() {
		return this[ TypeModel.getContext().fields.updatedOn ];
	}
	 ...
	 */
	getCreatedBy() {
		return this[ TypeModel.getContext().fields.createdBy ];
	}
	 ...
	 */
	getUpdatedBy() {
		return this[ TypeModel.getContext().fields.updatedBy ];
	}
