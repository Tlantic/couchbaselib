...
Couch.prototype.upsert = function(bucketName, docName, newDoc, resultCallback, retrieve) {
	async.waterfall([
		function(callback) {
...
Couch.prototype.get = internals.get = function(bucketName, docName, resultCallback ) {
	async.waterfall([
		function(callback) {
			internals.getBucket(bucketName, callback);
		},
...
Couch.prototype.getN1qlQuery = internals.getN1qlQuery = function(bucketName, query, resultCallback ) {
	async.waterfall([
		function(callback) {
			internals.getBucket(bucketName, callback);
		},
...
Couch.prototype.insert = function(bucketName, docName, doc, resultCallback, retrieve) {
	async.waterfall([
		function(callback) {
			internals.getBucket(bucketName, callback);
		},
...
Couch.prototype.getMulti = function(bucketName, docNames, resultCallback) {
	async.waterfall([
		function(callback) {
			internals.getBucket(bucketName, callback);
		},
...
Couch.prototype.remove = function(bucketName, docName, resultCallback) {
	async.waterfall([
		function(callback) {
			internals.getBucket(bucketName, callback);
		},
...
Couch.prototype.update = function(bucketName, docName, newDoc, resultCallback, retrieve) {
	async.waterfall([
		function(callback) {
			internals.getBucket(bucketName, callback);
		},
...
Couch.prototype.query = function(bucketName, design, viewQuery, resultCallback, options) {
